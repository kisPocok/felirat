...
describe("Movie/Helper", function() {
    ...
    describe("removeFileExtension", function() {
        it("removeFileExtensionShouldOk", function() {
    ...
    describe("getFileExtension", function() {
        it("rightFileNameShouldPass", function() {
            ...
            expect('Walking.Dead.s06e01').to.equal(actual);
        });

        it("emptyFileNameShouldThrowError", function() {
            var actual = Helper.removeFileExtension();
            expect(Helper.removeFileExtension.bind(Helper)).to.throw(/Cannot read property/); // permission denied
